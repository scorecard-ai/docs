...
<Update label="August 29, 2025">
  ...
  - **Testcase Validation**: Fixed schema validation when creating new testcases
  - **Run Status**: Real-time status updates on project cards
  - **UI Polish**: Improved empty states with documentation links
  - **Model Selector**: Fixed scrolling in Kickoff Run modal
  - **Results Refresh**: Charts now update immediately after run creation
</Update>
