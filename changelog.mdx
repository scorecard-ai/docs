...
<Update label="August 22, 2025">
  ...
  <DarkLightImage
    ...
    caption="CREATE TESTCASE button in trace overview - convert any span into a testcase"
  ...
  <DarkLightImage
    ...
    caption="Select target testset for your new testcase"
    alt="Screenshot of testset selection modal"
  />

  <DarkLightImage
    lightSrc="/images/monitors/trace-to-testcase-fields.png"
    caption="Auto-extracted fields ready for testcase creation"
  ...
  <DarkLightImage
    ...
    caption="Add testcase with metadata field marked as (Metadata)"
  ...
  - **[Security]** Improved docs search security by replacing dangerouslySetInnerHTML with proper sanitization
...
<Update label="August 8, 2025">
  ...
  - **Automated scoring**: Queue and execute scoring jobs on production traces using PGBoss scheduler
  ...
  - **[UI]** Test records now render ChatML format as chat bubbles instead of raw JSON
  - **[SDK]** Added `multi_turn_conversation` method for multi-turn simulations
