...
<Update label="August 1, 2025">
  ...
  - **Improved time filtering**: Fixed chart data accuracy when selecting different time ranges
  ...
  - **[Documentation]** Published tracing quickstart guide with Python, Node.js, Vercel AI SDK, and OpenLLMetry examples
</Update>
