...
<Update label="May 23, 2025">
  ...
  We're excited to announce the launch of our new [Screenshot of the new Scorecard homepage](https://scorecard.io/) homepage\! Explore our refreshed website with quick access to docs, product as well as a new visual design to share how Scorecard can support you as you're building your AI product.
  ...
  ![Custom Metrics Pn](/images/custom-metrics.png)
</Update>
...
<Update label="May 2, 2025">
  ...
  ![Eval Day Pn](/images/eval_day.png)
  ...
  ![Qa Docsbot Pn](/images/qa_docsbot.png)
