...
<Update label="September 26, 2025">
  ...
  <Frame caption="MCP Evals results page showing performance metrics and evaluation scores">
    <img src="/images/mcp-evals-results-light.png" alt="Screenshot of the MCP Evals platform results page" />
  </Frame>

  Key features:
  - **Dynamic Testing**: AI-generated evaluation tests tailored to each server's capabilities with results in seconds
  - **Performance Metrics**: View detailed server response times and capability assessments
  ...
  We've refreshed our card design throughout the platform for improved readability and modern aesthetics. The new design provides better visual hierarchy and cleaner information organization across all dashboard views.

  ### 📊 Float Output Type Support

  Scorecard now supports float output types for more precise numerical evaluations. This enhancement enables better measurement of continuous metrics and scoring systems that require decimal precision.

  <DarkLightImage
    lightSrc="/images/float-output-type-light.png"
    darkSrc="/images/float-output-type-dark.png"
    caption="New float output type option (0.0 - 1.0) alongside Boolean and Integer types"
    alt="Screenshot showing the float output type selection in metric configuration"
  />
...
<Update label="September 12, 2025">
  ...
  <img src="/images/mcp-ecosystem-diagram.svg" alt="MCP Ecosystem Diagram showing how MCP servers connect AI assistants with external tools and services" />
