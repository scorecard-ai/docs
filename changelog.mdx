...
<Update label="October 31, 2025">
  ...
  - **Manual OpenTelemetry**:
    ...
    - [Basic example](https://github.com/scorecard-ai/scorecard-examples/blob/main/nodejs-otel-basic/index.js): Getting started with OpenTelemetry

  ### 🛠️ Bug Fixes and Improvements

  - **[API]** Added new [Archive Records](/api-reference/delete-record) endpoint to archive records, helping you keep your workspace clean and organized
  - **[Runs]** Renamed "Trigger run" to "[Kickoff run](/features/runs)" for consistency across the platform
