...
<Update label="June 10, 2025">
  ...
  This dual approach means product managers can quickly create metrics while prompt engineers retain the flexibility to craft sophisticated evaluation logic.
...
<Update label="May 23, 2025">
  ...
  We're excited to announce the launch of our new [Scorecard homepage](https://scorecard.io/)\! Explore our refreshed website with quick access to docs, product as well as a new visual design to share how Scorecard can support you as you're building your AI product.

  ![Screenshot of the new Scorecard homepage](/images/homepage.png)

  ### ⚙️ Fully Configurable Metrics

  We've launched a new capability that allows two powerful new capabilities for your metrics:

  - Fully customize your evaluation model (GPT-4o, Claude-3, Gemini, etc.) or your own selected hosted model
  - We've also moved metrics to support structured outputs to significantly increase the reliability of your scores
