...
<Update label="September 5, 2025">
  ...
  Compare multiple system versions side-by-side to identify the best performing model configurations. Upload different system variations and evaluate them against the same testset to make data-driven decisions about your AI improvements.

  <DarkLightImage
    lightSrc="/images/a-b/ab-light.png"
    darkSrc="/images/a-b/ab-dark.png"
    caption={null}
    alt="Screenshot of the A/B comparison interface"
  />
  ...
  <DarkLightImage
    ...
    caption={null}
    alt="Screenshot of the A/B comparison modal"
  />

  Key capabilities:
  - **Side-by-side comparison**: Visually compare outputs from different system versions
  - **Statistical analysis**: Get confidence intervals and significance testing
  - **Batch evaluation**: Test multiple variations against the same dataset
  - **Performance insights**: Identify which model performs best across different metrics
  ...
  - [MCP Server Integration](/integrations/mcp) - Connect with AI tools via MCP protocol

  ### 🛠️ Bug Fixes and Improvements

  - **[Endpoints]** Improved endpoint selector UI for better usability
  - **[Organizations]** CSS cleanup on creating new organization flow
