...
<Update label="July 25, 2025">
  ...
  - **New tracing integration**: Published official integrations for Vercel AI SDK and OpenLLMetry with examples in both Python and Node.js. Our new step-by-step guide at docs.scorecard.io/intro/tracing-quickstart gets you from zero to traced LLM calls in minutes
  ...
  - **[Run details]** Sorting a columns show shows direction sort
</Update>
