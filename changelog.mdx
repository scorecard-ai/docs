...
<Update label="July 17, 2026">
  ...
  {/* TODO(screenshot): /images/changelog-session-attachments-{light,dark}.png — record details Files card and the Attachments tab with a file list */}
  ...
  {/* TODO(screenshot): /images/changelog-records-widgets-{light,dark}.png — widget board with a Volume widget and two metric widgets */}
  ...
  {/* TODO(screenshot): /images/changelog-trace-chat-skills-{light,dark}.png — trace chat with a skill attached as a chip and a skill-structured answer */}
