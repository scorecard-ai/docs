...
mode: "center"
---
<Update label="April 4, 2025" tags={["feature", "tracing", "examples", "bugfix"]}>
  ### Tracing
...
<Update label="March 14, 2025" tags={["ui", "feature"]}>
...
<Update label="February 24, 2025" tags={["feature", "export", "bugfix"]}>
...
<Update label="February 13, 2025" tags={["documentation"]}>
  ### Docs Site Revamp
...
<Update label="2024-10-12" description="v0.1.1" tags={["example", "screenshot"]}>
  <Frame>
...
<Update label="2024-10-11" description="v0.1.0" tags={["example", "code"]}>
  ### How to use
  ```md
  <Update label="2024-10-12" description="v0.1.1" tags={["tag1", "tag2"]}>
    This is how you use a changelog with a label, 
    description, and tags.
  </Update>
  <Update label="2024-10-11" description="v0.1.0" tags={["tag3"]}>
    This is how you use a changelog with a label, 
    description, and tags.
  </Update>
  ```
...
<Tip>
  Each `label` creates an anchor and also shows up on the table of contents on the right. The `tags` property allows for filtering in the right side panel.
</Tip>
