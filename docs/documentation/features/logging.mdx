...
Check out the [cookbooks](/docs/documentation/how-to-use-scorecard/cookbooks) that show you end-to-end Scorecard implementations and the demo project that shows you how to use [Logging with Scorecard](https://github.com/scorecard-ai/scorecard-tracing-demo)!
