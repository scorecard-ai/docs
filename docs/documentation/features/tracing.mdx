...
Every agent run is not automatically traced and available in your Scorecard AI dashboard.
...
Check out the [cookbooks](/docs/documentation/how-to-use-scorecard/cookbooks) that show you end-to-end Scorecard implementations and the demo project that shows you how to use [Tracing with Scorecard](https://github.com/scorecard-ai/scorecard-tracing-demo)!