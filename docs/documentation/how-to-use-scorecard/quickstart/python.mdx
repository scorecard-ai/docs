...
```py Create a Testset and Add Testcases
	...
	# Retrieve the ID of the demo_testset
	demo_testset_id = demo_testset.id
	
	# Add three Testcases
	client.testcase.create(
	   testset_id=demo_testset_id,
	...
	print(f"https://app.getscorecard.ai/view-dataset/{demo_testset_id}")
```
  </Step>
