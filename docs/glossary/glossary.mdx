...
[A](/docs/glossary/glossary#a) - [C](/docs/glossary/glossary#c) - [D](/docs/glossary/glossary#d) - [G](/docs/glossary/glossary#g) - [I](/docs/glossary/glossary#i) - [L](/docs/glossary/glossary#l) - [M](/docs/glossary/glossary#m) - [P](/docs/glossary/glossary#p) - [R](/docs/glossary/glossary#r) - [S](/docs/glossary/glossary#s) - [T](/docs/glossary/glossary#t) - [U](/docs/glossary/glossary#u)
...
A unique authentication token that grants secure access to Scorecard's services and features. API keys are required to make authenticated requests to the Scorecard API and are used to identify and track API usage.
...
The Scorecard Dashboard is a visual interface that provides an overview of your LLM evaluation metrics, test results, and performance analytics. It displays key insights, trends, and comparisons through charts, graphs, and summary statistics.
...
A type of artificial intelligence model trained on vast amounts of text data that can understand, generate, and manipulate human-like text. LLMs are the core technology being evaluated and monitored by Scorecard, including models from providers like OpenAI, Anthropic, and Google.
...
A specific implementation of a Large Language Model (LLM) with defined parameters and capabilities. Models can vary in size, specialization, and performance characteristics. Examples include GPT-4, Claude 2, and PaLM.
