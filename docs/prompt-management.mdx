...
<Note>
  When it comes to large language models (LLMs), a prompt refers to the specific
  instructions a user provides to produce an expected output.
</Note>
...
<figure style={{ textAlign: "center" }}>
  <img
    src="../images/scorecard-platform-prompts-view.png"
    alt="Prompts View in the Scorecard Platform"
    style={{
      display: "block",
      marginLeft: "auto",
      marginRight: "auto",
...
<figure style={{ textAlign: "center" }}>
  <img
    src="../images/scorecard-platform-prompt-creation.png"
    alt="Assisted Prompt Creation in Scorecard"
    style={{
      display: "block",
      marginLeft: "auto",
      marginRight: "auto",
...
<figure style={{ textAlign: "center" }}>
  <img
    src="../images/scorecard-platform-prompt-creation-model-info-box.png"
    alt="Interactive Model Background Information in Prompts Creation"
    style={{
      display: "block",
      marginLeft: "auto",
      marginRight: "auto",
  ...
  <span style={{ color: "gray" }}>
    Interactive Model Background Information in Prompts Creationd
  </span>
</figure>
...
<figure style={{ textAlign: "center" }}>
  <img
    src="../images/scorecard-platform-prompt-creation-prompt-message-split-up.png"
    alt="Split up Prompt Messages in Prompts Creation"
    style={{
      display: "block",
      marginLeft: "auto",
      marginRight: "auto",
  ...
  />
  <span style={{ color: "gray" }}>
    Split up Prompt Messages in Prompts Creation
  </span>
</figure>
...
<figure style={{ textAlign: "center" }}>
  <img
    src="../images/scorecard-playground.png"
    alt="Scorecard Playground: Prompt Mask"
    style={{
      display: "block",
      marginLeft: "auto",
      marginRight: "auto",
...
<figure style={{ textAlign: "center" }}>
  <img
    src="../images/scorecard-playground-search-for-prompts.png"
    alt="Scorecard Playground: Searching a Saved Prompt"
    style={{
      display: "block",
      marginLeft: "auto",
      marginRight: "auto",
...
<figure style={{ textAlign: "center" }}>
  <img
    src="../images/scorecard-platform-prompt-unique-id.png"
    alt="Unique IDs of Prompts"
    style={{
      display: "block",
      marginLeft: "auto",
      marginRight: "auto",
...
<figure style={{ textAlign: "center" }}>
  <img
    src="../images/scorecard-platform-prompt-management.png"
    alt="Prompt Versioning in Scorecard"
    style={{
      display: "block",
      marginLeft: "auto",
      marginRight: "auto",
