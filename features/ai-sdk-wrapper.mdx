...
<Info>
  When you provide metric descriptions, Scorecard automatically creates the metrics if they don't exist. Learn more about [metrics](/features/xmetrics).
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Monitoring" href="/intro/monitoring-quickstart">
