...
### Build on Scorecard's LLM Evaluation Expertise and Use Templates
...
## Automated Scoring: Scale Your Evaluation Process
...
### Consistently Evaluate LLM Applications in Multiple Dimensions With Metric Groups
