...
Custom Endpoints in Scorecard allow you to test and evaluate any HTTP API endpoint - whether it's your production API, a staging environment, or a local development server. This feature enables you to:

- **Test any API**: REST APIs, GraphQL endpoints, webhooks, or any HTTP-accessible service
- **Validate responses**: Ensure your endpoints return expected data structures and values
- **Monitor performance**: Track response times and reliability across deployments
- **Integrate with CI/CD**: Automate endpoint testing as part of your deployment pipeline
...
Once configured, endpoints can be used as systems in your test runs:
...
<Card title="API Reference" icon="code" href="/api-reference/systems/create">
