...
<DarkLightImage lightSrc="/images/github-configuration-page-light.png" caption="Triggering a run manually from the Scorecard UI." alt="Screenshot of the trigger run page in the Scorecard UI." />
