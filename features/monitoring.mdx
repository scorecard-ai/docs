---
title: "Tracing: Production monitoring"
...
<DarkLightImage
  ...
  caption="Monitor results – production traces with scores."
...
1. Navigate to the **Traces** page in your project. You'll see the monitoring rules overview table at the top of the page.
2. Click **“Add +”** to open the Create Monitor modal.
...
- **Run now** to trigger a monitor immediately without waiting for the next scheduled run. You can also specify a custom lookback time range to evaluate traces from a specific period.
...
<Note>
Ready to set one up? Follow the [Online Evaluation & Production Monitoring Quickstart](/intro/monitoring-quickstart).
</Note>