...
<DarkLightImage
  lightSrc="/images/kickoff-run-light.png"
  caption="Kickoff Run modal."
  alt="Screenshot of the kickoff run modal in the UI."
/>
...
<DarkLightImage
  ...
  caption="Triggering a run through the Scorecard GitHub integration."
