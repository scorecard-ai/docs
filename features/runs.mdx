...
The **Records** page provides a project-level view of all test records across your runs. This is useful when you want to:

- Search and filter records across multiple runs
- Analyze patterns in test results without navigating through individual runs
- View metric scores for all records in one place

The page includes structured filters, pagination, customizable columns, and a JSON viewer for complex input/output fields.
