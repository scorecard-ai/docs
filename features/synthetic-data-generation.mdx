...
<Steps>
  ...
  <Step title="Configure Parameters">
    - **Number of test cases**: How many to generate (5-500)
    - **Model**: Which AI model to use for generation
    - **Temperature**: Creativity level (0.3 for consistent, 0.8 for diverse)
  </Step>
  
  <Step title="Provide Input">
    - For few-shot: Select 3-5 existing test cases as examples
    - For schema: Define your data structure
    - For prompt: Write detailed instructions
  </Step>
...
<Card title="Best Practices" icon="lightbulb" href="/how-to-use-scorecard/creating-test-cases">
  Guidelines for creating effective test cases
</Card>

<Card title="API Reference" icon="code" href="/api-reference/testsets/generate">
