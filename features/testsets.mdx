...
A **Testset** is a collection of **Testcases** used to evaluate the performance of an AI system across various inputs and scenarios. Think of it as a curated dataset specifically designed for testing AI systems. Testsets are datasets that belong to a central theme like "Core Functionality", "Edge Cases", or "Customer Support Queries".
