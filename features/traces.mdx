...
Scorecard automatically captures and categorizes errors in your traces:

### Error Types

<Info>
  Errors are automatically detected and classified to help you quickly identify and resolve issues.
</Info>

- **Model Errors**: Rate limits, timeouts, invalid requests
- **Application Errors**: Exceptions, crashes, logic errors
- **Validation Errors**: Schema mismatches, type errors
- **Integration Errors**: API failures, network issues
