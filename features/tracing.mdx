...
Add the `scorecard.tracing_group_id` attribute to your spans with a shared identifier. Spans with the same group ID are automatically grouped into a single run.
