...
- **OpenAI Agents** – Assistants API and function calling
- **Langflow** – Visual workflow builder

### LLM Providers
OpenAI, Azure OpenAI, Anthropic, Cohere, Ollama, Mistral AI, HuggingFace, AWS Bedrock, AWS SageMaker, Replicate, Google Vertex AI, Google Gemini, IBM Watsonx AI, Together AI, Aleph Alpha, Groq, and more.

### Vector Databases
Chroma, Pinecone, Qdrant, Weaviate, Milvus, Marqo, LanceDB
...
For frameworks or providers not listed above, use OpenLLMetry's `instrument_http()` for HTTP-based APIs or emit spans manually using OpenTelemetry—see [Custom Providers](/features/custom-provider).
