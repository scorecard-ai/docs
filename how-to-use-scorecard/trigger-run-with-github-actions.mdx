...
<Frame caption="Triggering a run manually from the Scorecard UI." height="500">
    <img className="block dark:hidden" height="100" src="/images/trigger-run-light.jpeg" alt="Screenshot of the trigger run page in the Scorecard UI." />
    <img className="hidden dark:block" height="100" src="/images/trigger-run-dark.jpeg" alt="Screenshot of the trigger run page in the Scorecard UI." />
</Frame>
