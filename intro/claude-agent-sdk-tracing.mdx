...
This quickstart shows how to send traces from your Claude Agent SDK (Python v0.2.71+, TypeScript v0.1.71+) applications to Scorecard for observability, debugging, and evaluation.
