...
<Steps>
  ...
  <Step title="Create an Anthropic-hosted environment">
    Go to [**Cloud environments**](https://claude.ai/admin-settings/cloud-environments) in your Claude admin settings and create a new Anthropic-hosted environment. Name it something like "Scorecard Tracing".
    ...
    <DarkLightImage lightSrc="/images/claude-tag-create-environment.png" alt="Create an Anthropic-hosted environment dialog with the Environment variables field highlighted" caption="Add the tracing variables to the Environment variables field." width="480" />
  ...
  <Step title="Assign the environment to Claude Tag">
    ...
    <DarkLightImage lightSrc="/images/claude-tag-environment-setting.png" alt="Advanced section of Claude Tag's access on the Slack tab, with the Environment dropdown highlighted" caption="Set Environment under Claude Tag's access → Slack → Advanced." />
  ...
  <Step title="View traces in Scorecard">
    ...
    <DarkLightImage lightSrc="/images/claude-tag-records-light.png" darkSrc="/images/claude-tag-records-dark.png" alt="Scorecard Records table with one Claude Tag session record highlighted" caption="Each Claude Tag session arrives as a record." />
