...
<AccordionGroup>
  ...
  <Accordion title="How does Scorecard help agents self-improve?">
    ...
    - **Broad scenario coverage**: Test against **tool-calling workflows**, **edge cases and adversarial inputs**, and **enterprise environments** *(coming soon)*.
  ...
  <Accordion title="Can Scorecard be used for agent improvement and continuous learning?">
    ...
    **Continuous Feedback Loops**:
    ...
    See our [A/B Comparison](/features/a-b-comparison) docs for specific improvement workflows.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Can Scorecard test agentic workflows and multi-step AI agents?">
    ...
    **Agentic Capabilities**:
    ...
    - **Agent APIs**: Evaluate deployed agents by calling them from your own code with the SDK

    **How It Works**:
    - Use **Systems** to version your complete agent configuration (prompts + tools + settings)
    - Use the **SDK** to run your agent against a testset and record every response
    ...
    See our [Tracing](/features/tracing) documentation for agent-specific features.
  </Accordion>
