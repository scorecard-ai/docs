...
<AccordionGroup>
  <Accordion title="What are the text limits in Scorecard?">
    Scorecard is designed to handle extensive text inputs and outputs for AI evaluation. While there are no strict character limits for individual testcase fields, practical limits depend on your evaluation models' context windows and processing capabilities.
