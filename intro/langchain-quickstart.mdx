...
<Steps>
  ...
  <Step title="Run your LangChain application">
    ...
    ```python title="example.py" highlight={1-7} [expandable]
    from traceloop.sdk import Traceloop
    from traceloop.sdk.instruments import Instruments
  ...
  <Step title="View traces in Scorecard">
    ...
    <DarkLightImage lightSrc="/images/records-details-claude-sdk-light.png" darkSrc="/images/records-details-claude-sdk-dark.png" alt="Trace details view" caption="Trace details with chain execution and LLM call data" />
  </Step>
</Steps>
