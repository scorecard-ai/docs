...
<CardGroup cols={2}>
  ...
  <Card title="Cookbooks" icon="utensils" href="/how-to-use-scorecard/cookbooks">
    Explore code examples showing how to implement Scorecard end-to-end.
  </Card>
  <Card title="Guides" icon="book-open" href="/how-to-use-scorecard/guides/create-a-testset/using-the-testset-ui">
