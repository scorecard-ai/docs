...
<CardGroup cols={2}>
  ...
  <Card title="Try the playground" icon="wand-magic-sparkles" href="/features/playground">
    Test prompts without writing code
  </Card>
  <Card title="Technical overview" icon="gear" href="/intro/technical-system-overview">
