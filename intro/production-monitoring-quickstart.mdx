...
<Steps>
  ...
  <Step title="Configure a Monitor">
    ...
    <Frame caption="Create monitor">
      ![Create monitor](/images/monitoring/create-monitor-placeholder.png)
    </Frame>
    **How sampling works**
    ...
    <Frame caption="Monitor settings – sampling rate">
      ![Sampling settings](/images/monitoring/sampling-placeholder.png)
    </Frame>
  ...
  <Step title="Watch live dashboards">
    ...
    <Frame caption="Monitoring dashboard">
      ![Monitoring dashboard](/images/monitoring/dashboard-placeholder.png)
    </Frame>
  </Step>
</Steps>
