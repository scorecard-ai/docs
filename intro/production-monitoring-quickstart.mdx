...
Scorecard can evaluate live requests as they flow through your application. This guide shows how to set up a Monitor, how sampling and filters work, where prompts/completions are taken from, and what to expect after enabling monitoring.
...
<Steps>
  ...
  <Step title="Watch live dashboards">
    ...
    - Trends over time to spot drift.
    - Recent spans with individual scores and links back to full traces.
  </Step>
</Steps>
