...
mode: "center"
---
import { AdaptiveModeImage } from "/snippets/adaptive-mode-image.mdx";
...
<Steps>
  ...
  <Step title="Create Metrics">
    ...
    <Frame caption="Creating a Metric in the Scorecard UI." height="500">
      <AdaptiveModeImage
        lightImage="/images/quickstart/create-metric-light.png"
        darkImage="/images/quickstart/create-metric-dark.png"
        caption="Screenshot of creating a 'Tone accuracy' metric."
      />
    </Frame>
  ...
  <Step title="Analyze results">
    ...
    <Frame caption="Viewing results in the Scorecard UI." height="500">
      <AdaptiveModeImage
        lightImage="/images/quickstart/scoring-done-light.png"
        darkImage="/images/quickstart/scoring-done-dark.png"
        caption="Screenshot of viewing results in the Scorecard UI."
      />
    </Frame>
  </Step>
</Steps>