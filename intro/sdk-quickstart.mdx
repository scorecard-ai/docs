...
Scorecard has [Python v3.2.1](https://pypi.org/project/scorecard-ai) and [JavaScript v2.2.0](https://www.npmjs.com/package/scorecard-ai) SDKs. If you're using Python, you can follow along in [Google Colab](https://colab.research.google.com/drive/1A53j48o75Decrjz7WzDVP62XeDEKCHHP).
