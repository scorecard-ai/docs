...
Scorecard has Python [![PyPI version](https://badge.fury.io/py/scorecard-ai.svg)](https://pypi.org/project/scorecard-ai/) and JavaScript [![npm version](https://badge.fury.io/js/scorecard-ai.svg)](https://www.npmjs.com/package/scorecard-ai) SDKs. If you're using Python, you can follow along in [Google Colab](https://colab.research.google.com/drive/1A53j48o75Decrjz7WzDVP62XeDEKCHHP).
