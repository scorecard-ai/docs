...
Scorecard has Python and JavaScript SDKs. The latest versions are Python **v3.2.1** [![PyPI](https://img.shields.io/pypi/v/scorecard-ai)](https://pypi.org/project/scorecard-ai/) and JavaScript **v2.2.0** [![npm](https://img.shields.io/npm/v/scorecard-ai)](https://www.npmjs.com/package/scorecard-ai). If you're using Python, you can follow along in [Google Colab](https://colab.research.google.com/drive/1A53j48o75Decrjz7WzDVP62XeDEKCHHP).
