...
Scorecard has [Python](https://pypi.org/project/scorecard-ai/) and [TypeScript](https://www.npmjs.com/package/scorecard-ai) SDKs. The latest versions are **Python v3.2.1** and **TypeScript v2.2.0**. If you're using Python, you can follow along in [Google Colab](https://colab.research.google.com/drive/1A53j48o75Decrjz7WzDVP62XeDEKCHHP).
