...
## <Icon icon="building" /> Architecture Overview
...
## <Icon icon="diagram-project" /> Product System Architecture
...
## <Icon icon="cube" /> Core Primitives
...
## <Icon icon="list-check" /> Implementation Workflow
...
## <Icon icon="code" /> Developer Resources
