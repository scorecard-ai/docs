...
In order to build a Sample Testset, you can take 5-10 of your favorite prompts or queries that you generally use for testing.
...
Once you have your Golden Testset, you can start executing it on the playground. This is a fast way of iterating on prompts or trying out different models on Testsets or arbitrary inputs. You can find more details on the [playground guide](/features/playground).

Another way of kicking off execution is via your own LLM application in production. This will allow you to collect data on the quality of your application’s responses. You can do this via the [Scorecard SDK](/how-to-use-scorecard/trigger-run-with-github-actions).
