...
<Info>
  Prefer a hands-on demo? Skip the manual setup and launch this quickstart in Google Colab. [Run in Google Colab →](https://colab.research.google.com/github/scorecard-ai/scorecard-examples/blob/main/python-jupyter-openllmetry-openai/openllmetry_openai_example.ipynb)
</Info>
