...
<Info>
OpenAI is used in the examples below, but it’s not a requirement. Scorecard works with all major providers (OpenAI, Anthropic/Claude, Google Gemini, Groq, AWS Bedrock, and more). You can swap the OpenAI client and model for your preferred provider. See <a href="/features/custom-provider">Custom Providers</a> for details.
</Info>
