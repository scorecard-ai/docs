...
<Steps>
  ...
  <Step title="Kick off your first run">
    ...
    <DarkLightImage
      lightSrc="/images/example-project/kickoff-modal-pick-testset-full-light.png"
      darkSrc="/images/example-project/kickoff-modal-pick-testset-full-dark.png"
    ...
    <DarkLightImage
      lightSrc="/images/example-project/kickoff-modal-pick-metrics-full-light.png"
      darkSrc="/images/example-project/kickoff-modal-pick-metrics-full-dark.png"
    ...
    <DarkLightImage
      lightSrc="/images/example-project/kickoff-modal-success-toast-full-light.png"
      darkSrc="/images/example-project/kickoff-modal-success-toast-full-dark.png"
