...
<CardGroup cols={2}>
  ...
  <Card title="Install the SDK" icon="code" href="/how-to-use-scorecard/using-the-sdk">
...
<CardGroup cols={3}>
  ...
  <Card title="Example Testsets" icon="folder" href="/how-to-use-scorecard/importing-test-cases">
    Templates for common use cases
  </Card>
  <Card title="Best Practices" icon="star" href="/how-to-use-scorecard/best-practices">
...
- **Technical details:** [System Architecture](/intro/technical-system-overview) for engineers
- **Integration guides:** Connect with [GitHub Actions](/how-to-use-scorecard/trigger-run-with-github-actions), [CI/CD](/how-to-use-scorecard/ci-cd), and more
