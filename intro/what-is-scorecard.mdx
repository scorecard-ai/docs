...
## <Icon icon="hand-wave" /> Welcome to Scorecard
...
## <Icon icon="users" /> Why teams choose Scorecard

<Tabs>
  <Tab title="For Engineers" icon="code">
  ...
  <Tab title="For Leaders" icon="crown">
    ### Scale AI reliably
...
## <Icon icon="chart-line-up" /> From manual testing to automation
...
## <Icon icon="gear" /> How Scorecard works

<Steps>
  <Step title="Create your testset" icon="database">
  ...
  <Step title="Run your tests" icon="play">
  ...
  <Step title="Evaluate results" icon="chart-line">
...
## <Icon icon="rocket" /> Start building better LLM apps today
...
### <Icon icon="book-open" /> Resources to get started
...
### <Icon icon="graduation-cap" /> Learn more
