...
<Steps>
  ...
  <Step title="Simulate at scale">
    Run your agent through thousands of realistic scenarios. Generate diverse test scenarios automatically — no manual case writing required.

    [Synthetic data generation →](/features/synthetic-data-generation) · [Testsets →](/features/testsets)
  </Step>
  <Step title="Compare and improve">
    Quantitative A/B comparison across every metric. Iterate on prompts with real-time feedback to find the best prompt, model, or architecture.

    [A/B comparison →](/features/a-b-comparison) · [Prompts →](/features/prompts)
  </Step>
...
<CardGroup cols={3}>
  <Card title="Claude Agent SDK" icon="bolt" href="/intro/claude-agent-sdk-tracing">
    Zero-code tracing. Set a few environment variables and get full visibility into agent decisions, tool use, and costs.
  </Card>
...
<CardGroup cols={3}>
  ...
  <Card title="Explore your records" icon="beaker" href="/features/records">
    See every run, score, and trace in one place.
  </Card>
