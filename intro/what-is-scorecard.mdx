...
<CardGroup cols={3}>
  <Card title="Claude Code & Agent SDK" icon="bolt" href="/intro/claude-agent-sdk-tracing">
    Zero-code tracing. Set a few environment variables and get full visibility into agent decisions, tool use, and costs—for CLI sessions and SDK agents alike.
  </Card>
