Another way of kicking off evaluations is via the Scorecard SDK. To further automate your development workflows, you can integrate Scorecard by GitHub Actions. Through this platform, evaluations are seamlessly run and integrated with your codebase, either automatically upon specific triggers or manually when needed.
...
<figure style={{ textAlign: "center" }}>
    <img src="https://fern-image-hosting.s3.amazonaws.com/scorecard-docs/scorecard-doctorgpt-eval.png" alt="DoctorGPT workflow PR trigger" style={{ display: "block", marginLeft: "auto", marginRight: "auto", marginBottom: "10px" }} width="1000"/>
    <span style={{ color: "gray" }}>DoctorGPT workflow PR trigger</span>
</figure>   
...
<figure style={{ textAlign: "center" }}>
    <img src="https://fern-image-hosting.s3.amazonaws.com/scorecard-docs/scorecard-doctorgpt-eval-updated.png" alt="DoctorGPT workflow event trigger" style={{ display: "block", marginLeft: "auto", marginRight: "auto", marginBottom: "10px" }} width="1000"/>
    <span style={{ color: "gray" }}>DoctorGPT workflow event trigger</span>
</figure>   
